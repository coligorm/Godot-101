...
@onready var camera_3d: Camera3D = $SubViewport/LightDetection/Camera3D
@onready var mesh_instance_3d: MeshInstance3D = $SubViewport/LightDetection/MeshInstance3D
@onready var texture_rect: TextureRect = $TextureRect
@onready var color_rect: ColorRect = $ColorRect
@onready var light_level: TextureProgressBar = $LightLevel
